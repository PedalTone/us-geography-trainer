...
(function () {
  ...
  var STATE_FACTS = {
    'Alabama': { neighbor: 'Tennessee', river: 'the Tennessee River' },
    'Alaska': { neighbor: 'Canada', river: 'the Yukon River' },
    'Arizona': { neighbor: 'Nevada', river: 'the Colorado River' },
    'Arkansas': { neighbor: 'Missouri', river: 'the Mississippi River' },
    'California': { neighbor: 'Nevada', river: 'the Sacramento River' },
    'Colorado': { neighbor: 'Wyoming', river: 'the Colorado River' },
    'Connecticut': { neighbor: 'New York', river: 'the Connecticut River' },
    'Delaware': { neighbor: 'Pennsylvania', river: 'the Delaware River' },
    'Florida': { neighbor: 'Georgia', river: 'the St. Johns River' },
    'Georgia': { neighbor: 'Tennessee', river: 'the Chattahoochee River' },
    'Hawaii': { neighbor: 'the Pacific Ocean', river: 'the Wailuku River' },
    'Idaho': { neighbor: 'Canada', river: 'the Snake River' },
    'Illinois': { neighbor: 'Indiana', river: 'the Mississippi River' },
    'Indiana': { neighbor: 'Ohio', river: 'the Wabash River' },
    'Iowa': { neighbor: 'Minnesota', river: 'the Des Moines River' },
    'Kansas': { neighbor: 'Nebraska', river: 'the Arkansas River' },
    'Kentucky': { neighbor: 'Tennessee', river: 'the Kentucky River' },
    'Louisiana': { neighbor: 'Arkansas', river: 'the Mississippi River' },
    'Maine': { neighbor: 'New Hampshire', river: 'the Kennebec River' },
    'Maryland': { neighbor: 'Virginia', river: 'the Potomac River' },
    'Massachusetts': { neighbor: 'New York', river: 'the Connecticut River' },
    'Michigan': { neighbor: 'Indiana', river: 'the Grand River' },
    'Minnesota': { neighbor: 'Canada', river: 'the Minnesota River' },
    'Mississippi': { neighbor: 'Louisiana', river: 'the Mississippi River' },
    'Missouri': { neighbor: 'Iowa', river: 'the Missouri River' },
    'Montana': { neighbor: 'Canada', river: 'the Yellowstone River' },
    'Nebraska': { neighbor: 'Colorado', river: 'the Platte River' },
    'Nevada': { neighbor: 'California', river: 'the Humboldt River' },
    'New Hampshire': { neighbor: 'Vermont', river: 'the Merrimack River' },
    'New Jersey': { neighbor: 'New York', river: 'the Delaware River' },
    'New Mexico': { neighbor: 'Texas', river: 'the Rio Grande' },
    'New York': { neighbor: 'Pennsylvania', river: 'the Hudson River' },
    'North Carolina': { neighbor: 'Virginia', river: 'the Neuse River' },
    'North Dakota': { neighbor: 'Canada', river: 'the Missouri River' },
    'Ohio': { neighbor: 'Pennsylvania', river: 'the Ohio River' },
    'Oklahoma': { neighbor: 'Texas', river: 'the Canadian River' },
    'Oregon': { neighbor: 'Washington', river: 'the Willamette River' },
    'Pennsylvania': { neighbor: 'New York', river: 'the Susquehanna River' },
    'Rhode Island': { neighbor: 'Massachusetts', river: 'the Blackstone River' },
    'South Carolina': { neighbor: 'North Carolina', river: 'the Savannah River' },
    'South Dakota': { neighbor: 'North Dakota', river: 'the Missouri River' },
    'Tennessee': { neighbor: 'Kentucky', river: 'the Tennessee River' },
    'Texas': { neighbor: 'Oklahoma', river: 'the Colorado River' },
    'Utah': { neighbor: 'Idaho', river: 'the Green River' },
    'Vermont': { neighbor: 'New Hampshire', river: 'the Connecticut River' },
    'Virginia': { neighbor: 'West Virginia', river: 'the James River' },
    'Washington': { neighbor: 'Oregon', river: 'the Columbia River' },
    'West Virginia': { neighbor: 'Virginia', river: 'the New River' },
    'Wisconsin': { neighbor: 'Illinois', river: 'the Wisconsin River' },
    'Wyoming': { neighbor: 'Colorado', river: 'the North Platte River' },
  };
